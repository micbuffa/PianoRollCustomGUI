...
class PianoRollCustomGUI {
    constructor(nbrows, nbBars, timeSigNumerator, timeSigDenominator) {
        this.cells = [];
        ...
        // beat subdivision (one cell) duration in milliseconds
        this.beatSubdivisionDuration = (60 / this.tempo) * 1000 / this.timeSignatureDenominator; // in milliseconds
        this.started = false;
    }
    ...
    draw() {
        ...
        if (this.started) {            
            ...
            //this.playheadPosition += inc;
            if (this.playheadPosition > this.cols) {
            ...
            this.timeElaspedSinceStart = (audioContext.currentTime * 1000) - this.startTime;
    ...
    start() {
        ...
        this.startTime = audioContext.currentTime * 1000; // in milliseconds
        //console.log(this.timeElaspedSinceStart);
    }
